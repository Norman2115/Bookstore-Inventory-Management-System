 ...
 * @author Tay Xuan Ye
 */
public class EditBookViewPage extends javax.swing.JInternalFrame {

    /**
     * Creates new form EditBookViewPage.
     */
    public EditBookViewPage() {
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(EditBookViewPage.class.getName()).log(Level.SEVERE, "Failed to read book data", ex);
        } catch (IOException ex) {
            UIUtils.displayErrorMessage("Failed to convert picture to the required format: " + ex.getMessage());
            Logger.getLogger(EditBookViewPage.class.getName()).log(Level.SEVERE, "Failed to convert picture to the required format", ex);
        }
    }
    ...
    private void displayTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_displayTableMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            try {
                ...
                AdminHomePage.createEditBookInfoPage(bookDatas[0]);
            } catch (SQLException ex) {
                UIUtils.displayErrorMessage("Failed to read book data: " + ex.getMessage());
                Logger.getLogger(EditBookViewPage.class.getName()).log(Level.SEVERE, "Failed to read book data", ex);
            } catch (IOException ex) {
