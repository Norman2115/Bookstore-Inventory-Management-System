 ...
 * @author Tay Xuan Ye
 */
public class AddBookPage extends javax.swing.JInternalFrame {
    ...
    private void checkBookTitleValid() {
        ...
        // Check if the entered book title is empty
        if (bookTitle.trim().isEmpty()) {
            // Reset the field state and clear error message
            UIUtils.resetFieldState(bookTitleField);
            UIUtils.resetErrorLabel(bookTitleErrorLabel);
            return;
        }
        ...
        // If book title is invalid, mark the field as erroneous and display error message
    ...
    private void checkAuthorValid() {
        ...
        // If author name is invalid, mark the field as erroneous and display error message
    ...
    private void checkPublisherValid() {
        ...
        // Check if the entered publisher name is empty
        ...
        // If publisher name is invalid, mark the field as erroneous and display error message
    ...
    private void checkYearValid() {
        ...
        // Check if the entered publication year is empty
        ...
        // If publication year is invalid, mark the field as erroneous and display error message
    ...
    private void checkQuantityValid() {
        ...
        // Check if the entered stock quantity is empty
        ...
        // If stock quantity is invalid, mark the field as erroneous and display error message
    ...
    private void checkUnitPriceValid() {
        ...
        // Check if the entered unit price is empty
        ...
        // If unit price is invalid, mark the field as erroneous and display error message
    ...
    private void checkDiscountValid() {
        ...
        // Check if the entered discount is empty
        ...
        // If discount is invalid, mark the field as erroneous and display error message
    ...
    private void checkISBNValid() {
        ...
        // Check if the entered ISBN is empty
        if (isbn.isEmpty()) {
            UIUtils.resetFieldState(isbnField);
            UIUtils.resetErrorLabel(isbnErrorLabel);
            return;
        ...
        // If the ISBN is invalid, mark the field as erroneous and display the error message
        ...
        try {
            ...
            // If the ISBN is not unique, mark the field as erroneous and display the error message
            if (!isbnUniqueValidation.isValid()) {
                UIUtils.setFieldErrorState(isbnField);
                UIUtils.setErrorLabelMessage(isbnErrorLabel, isbnUniqueValidation.getErrorMessage());
            } else {
                // If the ISBN is valid and unique, reset the field state and clear the error message
                UIUtils.resetFieldState(isbnField);
                UIUtils.resetErrorLabel(isbnErrorLabel);
            }
        } catch (SQLException ex) {
            UIUtils.displayErrorMessage("Failed to check unique ISBN: " + ex.getMessage());
            Logger.getLogger(AddBookPage.class.getName()).log(Level.SEVERE, "Failed to check unique ISBN", ex);
        }
    }
        ...
        if (isBookTitleValid && isISBNValid && isGenreSelected
            ...
            try {
                ...
                try {
                    ...
                    UIUtils.displayErrorMessage("Failed to save book data: " + ex.getMessage());
                    Logger.getLogger(AddBookPage.class.getName()).log(Level.SEVERE, "Failed to save book data", ex);
                }
            } catch (IOException ex) {
                UIUtils.displayErrorMessage("Failed to convert image to required format: " + ex.getMessage());
                Logger.getLogger(AddBookPage.class.getName()).log(Level.SEVERE, ex.getMessage(), ex);
            }
        }
