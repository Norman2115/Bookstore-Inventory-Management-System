 ...
 * @author Tay Xuan Ye
 */
public class EditBookInfoPage extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form EditBookInfoPage.
     */
    ...
    private void addProductButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addProductButtonMouseClicked
        ...
        if (isBookTitleValid && isGenreSelected && isLanguageSelected
                && isAuthorValid && isPublisherValid
            ...
            try {
                // Check if a new cover page is selected
                ...
                UIUtils.displayErrorMessage("Failed to update book data: " + ex.getMessage());
                Logger.getLogger(EditBookInfoPage.class.getName()).log(Level.SEVERE, "Failed to update book data", ex);
            } catch (IOException ex) {
                UIUtils.displayErrorMessage("Failed to convert picture to the required format: " + ex.getMessage());
                Logger.getLogger(EditBookInfoPage.class.getName()).log(Level.SEVERE, "Failed to convert picture to the required format", ex);
            }
        }
