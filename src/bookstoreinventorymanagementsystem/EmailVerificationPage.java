...
public class EmailVerificationPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        banner.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/mailbox_line_art_pinterest_1.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmailVerificationPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
