 ...
 * @author Tay Xuan Ye
 */
public class ViewBookPage extends javax.swing.JInternalFrame {
    /**
    ...
    public ViewBookPage() {
        ...
        try {
            ...
            Logger.getLogger(ViewBookPage.class.getName()).log(Level.SEVERE, "Failed to read book data", ex);
        } catch (IOException ex) {
            UIUtils.displayErrorMessage("Failed to convert picture to the required format: " + ex.getMessage());
            Logger.getLogger(ViewBookPage.class.getName()).log(Level.SEVERE, "Failed to convert picture to the required format", ex);
        }
    }
    ...
    private void searchBarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBarActionPerformed
        ...
        if (searchBy.equals("all")) {
            ...
            condition = "book_title LIKE \'" + searchBar.getText() + "%\' OR "
                    ...
                    + "unit_price LIKE \'" + searchBar.getText() + "%\' OR "
                    + "discount LIKE \'" + searchBar.getText() + "%\'";
        } else {
    ...
    private void displayTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_displayTableMouseClicked
        if (evt.getClickCount() == 2) {
            ...
            try {
                ...
                AdminHomePage.createBookDetailPage(bookDatas[0]);
            } catch (SQLException ex) {
                UIUtils.displayErrorMessage("Failed to read book data: " + ex.getMessage());
                Logger.getLogger(ViewBookPage.class.getName()).log(Level.SEVERE, "Failed to read book data", ex);
            } catch (IOException ex) {
