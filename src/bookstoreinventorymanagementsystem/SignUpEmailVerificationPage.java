...
public class SignUpEmailVerificationPage extends javax.swing.JFrame {
    ...
    private void sendVerificationEmailAsync(String toEmail) {
        Thread emailThread = new Thread(() -> {
            try {
                ...
                Logger.getLogger(SignUpEmailVerificationPage.class.getName()).log(Level.SEVERE, "Failed to send email", ex);
            }
        });
        emailThread.start();
    }
    ...
    private void finishButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_finishButtonMouseClicked
        ...
        if (!enteredCode.trim().isEmpty()) {
            ...
            if (codeValidation.isValid()) {
                dispose();
                new ProfilePicturePage(userData, userDataStack).setVisible(true);
            } else {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new SignUpEmailVerificationPage(new UserData(), new NavigationStack<>()).setVisible(true);
        });
    }
